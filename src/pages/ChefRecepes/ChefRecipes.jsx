  ...
  return (
    ...
    <div className="my-5">
      ...
      <div className="card card-side bg-base-100 shadow-xl mx-5 p-5">
        <figure>
          <img src={img} alt="chef_picture" className="rounded-md h-[599px]" />
        </figure>
        <div className="card-body">
          ...
          <p className="text-xl font-bold">
            <span className=" text-md font-bold">Experience: </span> {experience}
          </p>
        </div>
      </div>
    </div>
    <h1 className="text-center font-bold text-2xl mt-6">Chef Recipes</h1>
    <div className="grid grid-cols-3 my-5 mx-5 gap-5">
      {recipe.map(r => <ChefRecipesDetails recipe={r}></ChefRecipesDetails>)}
    </div>
    </>
  );
};
