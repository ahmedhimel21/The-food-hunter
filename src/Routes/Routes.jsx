    ...
    children: [
      {
        path: '/',
        element: <Home></Home>,
        loader: () => fetch('https://the-food-hunter-server-ahmedhimel21.vercel.app/chef')
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        loader: ({params}) => fetch(`https://the-food-hunter-server-ahmedhimel21.vercel.app/chef/${params.id}`)
      }
    ]
  },
  {
